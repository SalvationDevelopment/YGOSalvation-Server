...
function preformfilter(translated, players, rooms, started, pid) {
    ...
    if (OK) {
        ...
        content = '<div class="game ' + rooms + ' ' + started + ' ' +  translated.isLocked + '" onclick=enterGame("' + rooms + '", "' + rooms + '") data-' + game + '="' + rooms + '">' + duelist + '<span class="subtext" style="font-size:.5em"><br>' + translated.gameMode +
