...
function preformfilter(translated, players, rooms, started) {
    ...
    if (OK) {
        duelist = (translated.gameMode === 'Single' || translated.gameMode === 'Match') ? players[0] + ' vs ' + players[1] : players[0] + '&amp' + players[1] + ' vs<br />&nbsp&nbsp&nbsp&nbsp ' + players[2] + ' &amp ' + players[3];
