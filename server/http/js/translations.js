var translationDB = [{
    ...
    "zh-hans": "如果有多张卡进行连锁，你可以让游戏自动排列连锁顺序。如果自排连锁是开启的，那么游戏会自动随机排列连锁顺序。",
    "zh-hant": "",
    "ko": "",
    ...
    "zh-hans": "没有（明显）的连锁延迟。在游戏中加入额外停顿来迷惑对手。",
    "zh-hant": "",
    "ko": "",
