...
function c80300001.desreptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		e:SetLabel(count)
		return bit.band(r,REASON_EFFECT)~=0 and count>0 and Duel.IsCanRemoveCounter(tp,1,0,0x5,count,REASON_EFFECT)
	end
...
function c80300001.desrepop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.RemoveCounter(tp,1,0,0x5,count,REASON_COST)
end
