...
function c6948.initial_effect(c)
	...
	e1:SetCountLimit(1,6948)
	e1:SetCondition(c6948.condition)
	e1:SetTarget(c6948.target)
	e1:SetOperation(c6948.operation)
	c:RegisterEffect(e1)
	--attack all
	local e2=Effect.CreateEffect(c)
	e2:SetType(EFFECT_TYPE_SINGLE)
	e2:SetCode(EFFECT_ATTACK_ALL)
	e2:SetValue(c6948.atkfilter)
	c:RegisterEffect(e2)
end
