...
function c1217.initial_effect(c)
	...
	e1:SetCondition(c1217.condition)
	e1:SetTarget(c1217.target)
	e1:SetOperation(c1217.activate)
	c:RegisterEffect(e1)
end
function c1217.condition(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c1217.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c1217.activate(e,tp,eg,ep,ev,re,r,rp)
