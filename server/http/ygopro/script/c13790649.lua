...
function c13790649.initial_effect(c)
	...
	e2:SetCondition(c13790649.splimcon)
	e2:SetTarget(c13790649.splimit)
	c:RegisterEffect(e2)
	...
	e5:SetCondition(c13790649.dircon)
	c:RegisterEffect(e5)
	local e6=e5:Clone()
	e6:SetCode(EFFECT_CANNOT_ATTACK)
	e6:SetCondition(c13790649.atkcon2)
	c:RegisterEffect(e6)
	...
	e7:SetValue(c13790649.tglimit)
	c:RegisterEffect(e7)
end
function c13790649.splimcon(e)
	return not e:GetHandler():IsForbidden()
end
function c13790649.splimit(e,c,tp,sumtp,sumpos)
	return not c:IsSetCard(0xab) and bit.band(sumtp,SUMMON_TYPE_PENDULUM)==SUMMON_TYPE_PENDULUM
end
function c13790649.value(e,c)
	return Duel.GetMatchingGroupCount(Card.IsSetCard,c:GetControler(),LOCATION_GRAVE,0,nil,0xab)*500
end
function c13790649.dircon(e)
	return e:GetHandler():GetAttackAnnouncedCount()>0
end
function c13790649.atkcon2(e)
	return e:GetHandler():IsDirectAttacked()
end

function c13790649.tglimit(e,re,c)
