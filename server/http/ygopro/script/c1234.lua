--Unbreakable Spirit
-- GO GO FIGHTO NTA RAWR FIXXXXXXXXXXXXXXXXXXXXXXXXXX
function c1234.initial_effect(c)
	...
	e1:SetCondition(c1234.condition)
	e1:SetTarget(c1234.target)
	e1:SetOperation(c1234.activate)
	c:RegisterEffect(e1)
end
function c1234.condition(e,tp,eg,ep,ev,re,r,rp)
	return (Duel.GetCurrentPhase()~=PHASE_DAMAGE or not Duel.IsDamageCalculated())
		and Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)==1
end
function c1234.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
