...
function c13718203.initial_effect(c)
	...
	e2:SetCondition(c13718203.condition)
	e2:SetTarget(c13718203.target)
	e2:SetOperation(c13718203.operation)
	c:RegisterEffect(e2)
	--To hand
	...
	e3:SetCost(c13718203.tkcost)
	e3:SetTarget(c13718203.tktg)
	e3:SetOperation(c13718203.tkop)
	c:RegisterEffect(e3)
	--to hand
	...
	e4:SetCost(c13718203.cost)
	e4:SetTarget(c13718203.tg)
	e4:SetOperation(c13718203.op)
	c:RegisterEffect(e4)
end
...
function c13718203.tkcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c13718203.tktg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c13718203.tkop(e,tp,eg,ep,ev,re,r,rp)
