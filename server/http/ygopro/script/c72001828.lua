...
function c72001828.initial_effect(c)
	...
	e2:SetCountLimit(1)
	e2:SetCondition(c72001828.descon)
	e2:SetOperation(c72001828.desop)
	c:RegisterEffect(e2)
	--Remove
	...
	e3:SetTarget(c72001828.rmtarget)
	...
	e4:SetTarget(c72001828.splimit)
	c:RegisterEffect(e4)
end
function c72001828.descon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp
end
function c72001828.desop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local con=Duel.CheckReleaseGroup(tp,nil,1,nil)
	local op=false
	if con then op=Duel.SelectYesNo(tp,aux.Stringid(72001828,0)) end
	if op then
...
function c72001828.splimit(e,c)
