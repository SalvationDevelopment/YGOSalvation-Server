...
function c211.spop(e,tp,eg,ep,ev,re,r,rp)
	if bit.band(ev,0x2)~=0 and Duel.GetLocationCount(1-tp,LOCATION_MZONE)>0
	...
	if bit.band(ev,0x1)~=0 and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,212,0,0x4011,0,0,1,RACE_PLANT,ATTRIBUTE_EARTH,POS_FACEUP) then
