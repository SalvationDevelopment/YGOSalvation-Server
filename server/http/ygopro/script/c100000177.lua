...
function c100000177.filter(c)
	return c:GetCode()==100000170
end
function c100000177.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c100000177.filter,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,nil) end
end
function c100000177.operation(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.SelectMatchingCard(tp,c100000177.filter,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,1,nil)
	local tc=g:GetFirst()
