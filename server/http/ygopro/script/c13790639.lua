...
function c13790639.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	and Duel.IsExistingMatchingCard(c13790639.filter,tp,LOCATION_DECK,0,1,nil) end
	e:SetLabel(0)
...
function c13790639.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g2=Duel.SelectMatchingCard(tp,c13790639.filter,tp,LOCATION_DECK,0,1,1,nil)
