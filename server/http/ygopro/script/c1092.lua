...
function c1092.initial_effect(c)
	...
	e1:SetCondition(c1092.eqcon)
	e1:SetOperation(c1092.eqop)
	c:RegisterEffect(e1)
end
function c1092.eqcon(e,tp,eg,ep,ev,re,r,rp)
...
function c1092.eqlimit(e,c)
	return e:GetOwner()==c
end
function c1092.eqop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
