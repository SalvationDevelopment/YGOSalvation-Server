...
function c1205.initial_effect(c)
	...
	e1:SetCondition(c1205.condition)
	e1:SetTarget(c1205.target)
	e1:SetOperation(c1205.activate)
	c:RegisterEffect(e1)
end
function c1205.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c1205.activate(e,tp,eg,ep,ev,re,r,rp)
	local a=Duel.GetAttacker()
	local d=Duel.GetAttackTarget()
