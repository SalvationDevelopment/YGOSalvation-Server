...
/**
 * Executes the invert helper used by the enums module.
 * @param {(string|Array)} target The target value provides an input used by the enums module.
 * @returns {Object} Returns the value produced by the enums module.
 */
...
/**
 * Makes check used by the enums module.
 * @param {string} target The target value provides an input used by the enums module.
