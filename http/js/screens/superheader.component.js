...
class SuperHeaderComponent extends React.Component {
    ...
    links(loggedIn) {
        if (loggedIn) {
            return [
                React.createElement('li', { onClick: this.nav.bind(this, 'news'), key: 'super-header-news', className: 'psudolinksingle' }, 'News'),
                ...
                React.createElement('li', { onClick: this.nav.bind(this, 'rankings'), key: 'super-header-rankings', className: 'psudolinksingle' }, 'Rankings'),
    ...
    render(loggedIn) {
        return React.createElement('div', { key: 'super-header-header', className: 'superheader', id: 'superheader' },
            React.createElement('ul', { key: 'super-header-list', className: 'featurelist', id: 'featurelist' }, [
                React.createElement('li', { onClick: this.nav.bind(this, 'login'), key: 'super-header-logo', className: 'psudolinksingle logolink', id: 'psudologo' },
