    ...
    links(loggedIn) {
        if (loggedIn) {
            return [
                ...
                React.createElement('li', { onClick: this.nav.bind(this, 'rankings'), key: 'rankings', className: 'psudolinksingle' }, 'Rankings'),
                ...
                React.createElement('li', { onClick: this.nav.bind(this, 'downloads'), key: 'downloads', className: 'psudolinksingle' }, 'Downloads'),
