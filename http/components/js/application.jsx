...
export default class ApplicationComponent extends React.Component {
    ...
    login(data) {
        ...
        console.log(info);
        this.store.hey({action: 'LOAD_DECKS', decks: info.decks});
        this.store.hey({action: 'LOGGEDIN'});
    ...
    language() {
        return React.createElement('div', {id: 'languagesetter', key: 'screen-languagesetter'}, [
            ...
            React.createElement('span', {
                key: 'screen-fr',
                onClick: this.translate.bind(this, 'fr')
            }, 'Français(France)'),
            React.createElement('span', {
                key: 'screen-frca',
                onClick: this.translate.bind(this, 'fr-ca')
            }, 'Français(Québec)'),
